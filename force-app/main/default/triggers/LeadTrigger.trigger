...
trigger LeadTrigger on Lead (before Insert, after insert,after update,before update) {
    if(trigger.isafter && trigger.Isinsert){
        ...
        if(ApexClass == 'true'){
            ...
            //LeadTriggerHandler.createTestRideIftheCreateTestRideCheckboxIsTicked(trigger.new); 
            //LeadTriggerHandler.convertLeadOnConversionIfTheBookRideIsChecked(trigger.new);
        }
    }
